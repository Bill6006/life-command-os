...
const PRODUCTION_SPEC =
  /(production-recovery|production-areas|production-fatherhood|production-learning-map|production-emotional|production-faith|production-home|production-money|production-command-core|production-repair|privacy-audit)\.spec\.ts/;
