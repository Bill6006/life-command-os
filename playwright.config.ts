...
const PRODUCTION_SPEC =
  /(production-recovery|production-areas|production-fatherhood|production-learning-map|production-emotional|production-faith|production-home|privacy-audit)\.spec\.ts/;
